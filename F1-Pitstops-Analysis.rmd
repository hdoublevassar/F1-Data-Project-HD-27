...
practice sessions. Therefore, there are some fundimental errors in my data collection methods that need to be addressed first.
  ...
  2. Iscolating Driver Names and Information
    - This step needs to be addressed more carefully since there were duplicates of the same drivers based off of driver number last time
    - Done
  3. Pitstop Data
...
PitPlot <- ggplot(data = pitstop_averages, aes(x = reorder(name_acronym, average_pitstop_time),
