...
```{r Plotting-Pitstops, include = FALSE}
PitPlot <- ggplot(pitstop_data, aes(date, pit_duration, colour = team_colour)) + 
  geom_point()+ 
  theme_bw()+
  labs(title = "Pitstops Over Time", x = "Date and Time", y  = "Pit Durations")+
...
ggplotly(TeamBoxplot, width = 1200, height = 700, align="center") %>%
